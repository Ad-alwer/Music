        ...
        <div class="mt-1">
          ...
          <div class="d-flex gap-1 flex-column">
            ...
            <select
              ...
              ref="typeinput"
            >
              <option value="podcast" class="text-capitalize">Podcast</option>
              <option value="music" class="text-capitalize">Music</option>
            </select>
          </div>
...
export default {
  ...
  mounted() {
    ...
    if (this.data) {
      ...
      this.$refs.typeinput.value = this.data.type;
      this.$refs.lyricinput.value = this.data.lyric;
  ...
  methods: {
    ...
    save: function () {
      if (
        ...
        formData.append("lyric", this.$refs.lyricinput.value);
        formData.append("genre", this.$refs.genreselect.value);
        formData.append("status", this.$refs.statusinput.value);
        formData.append("type", this.$refs.typeinput.value);
        formData.append("objectKey", this.$refs.tumbnailinput.files[0]);

        axios.put(`${this.apiaddress}upload/track`, formData).then((res) => {
